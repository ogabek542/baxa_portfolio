            ...
            <div className="flex flex-col xl:flex-row items-center gap-8 ">
              ...
              <div className="mb-8 xl:mb-0 ">
                <Socials
                  ...
                  iconStyles="w-[45px] h-[45px] p-[0px] border border-accent rounded-full flex justify-center items-center text-accent text-base hover:bg-accent hover:text-primary hover:transition-all duration-500"
                />
              </div>
            </div>
          </div>
